(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('rxjs'), require('@angular/core'), require('rxjs/operators'), require('detect-passive-events'), require('@angular/forms'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('ng5-slider', ['@angular/core','@angular/common','exports', 'rxjs', '@angular/core', 'rxjs/operators', 'detect-passive-events', '@angular/forms', '@angular/common'], factory) :
	(factory(global.ng.core,global.ng.common,(global['ng5-slider'] = {}),global.rxjs,global.ng.core,global.Rx.Observable.prototype,global.detectPassiveEvents,global.ng.forms,global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,exports,rxjs,core,operators,detectPassiveEvents,forms,common) { 
...
var _c13 = function (a0) { return { "ng5-slider-selected": a0 }; };
...
SliderHandleDirective.propDecorators = {
    "active": [{ type: core.HostBinding, args: ['class.ng5-slider-active',] },],
...
var SliderComponent = /** @class */ (function () {
    ...
    SliderComponent.prototype.subscribeInputModelChangeSubject = function (interval) {
        ...
        this.inputModelChangeSubscription = this.inputModelChangeSubject
            .pipe(operators.distinctUntilChanged(ModelChange.compare), operators.filter(function (modelChange) { return !modelChange.forceChange && !modelChange.internalChange; }), (!ValueHelper.isNullOrUndefined(interval))
...
Ng5SliderModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function Ng5SliderModule_Factory(t) { return new (t || Ng5SliderModule)(); }, imports: [[
            common.CommonModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(Ng5SliderModule, { declarations: [SliderComponent, SliderElementDirective, SliderHandleDirective, SliderLabelDirective, TooltipWrapperComponent], imports: [ɵngcc1.CommonModule], exports: [SliderComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Ng5SliderModule, [{
        type: core.NgModule,
        args: [{
                imports: [
                    common.CommonModule
