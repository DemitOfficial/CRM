(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/forms'),exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('flatpickr')) :
    typeof define === 'function' && define.amd ? define('ng2-flatpickr', ['@angular/core','@angular/common','@angular/forms','exports', '@angular/core', '@angular/forms', '@angular/common', 'flatpickr'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.forms,global['ng2-flatpickr'] = {}, global.ng.core, global.ng.forms, global.ng.common));
...
Ng2FlatpickrModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function Ng2FlatpickrModule_Factory(t) { return new (t || Ng2FlatpickrModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(Ng2FlatpickrModule, { declarations: [Ng2FlatpickrComponent, Ng2FlatpickrDirective], imports: [ɵngcc1.CommonModule], exports: [Ng2FlatpickrComponent, Ng2FlatpickrDirective] }); })();
