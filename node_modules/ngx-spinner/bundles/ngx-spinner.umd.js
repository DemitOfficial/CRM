(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/platform-browser'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/animations'), require('@angular/common'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('ngx-spinner', ['@angular/core','@angular/common','@angular/platform-browser','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/animations', '@angular/common', '@angular/platform-browser'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global.ng.platformBrowser,global['ngx-spinner'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.animations, global.ng.common, global.ng.platformBrowser));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, i0, rxjs, operators, animations, common, platformBrowser) { 
var _c0 = ["overlay"];
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxSpinnerService, [{
    ...
    var NgxSpinnerComponent = /** @class */ (function () {
        ...
        NgxSpinnerComponent.prototype.handleKeyboardEvent = function (event) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxSpinnerComponent, [{
    ...
    }], function () { return [{ type: NgxSpinnerService }, { type: ɵngcc0.ChangeDetectorRef }]; }, { disableAnimation: [{
            type: i0.Input
        }], bdColor: [{
            type: i0.Input
        }], zIndex: [{
    ...
    NgxSpinnerComponent.propDecorators = {
        ...
        showSpinner: [{ type: i0.Input }],
        disableAnimation: [{ type: i0.Input }],
        spinnerDOM: [{ type: i0.ViewChild, args: ['overlay',] }],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxSpinnerModule, { declarations: [NgxSpinnerComponent, SafeHtmlPipe], imports: [ɵngcc1.CommonModule], exports: [NgxSpinnerComponent] }); })();
