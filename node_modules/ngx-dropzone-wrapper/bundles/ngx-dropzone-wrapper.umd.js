(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('dropzone')) :
    typeof define === 'function' && define.amd ? define('ngx-dropzone-wrapper', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common', 'dropzone'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ngx-dropzone-wrapper'] = {}, global.ng.core, global.ng.common, global.Dropzone));
}(this, (function (ɵngcc0,ɵngcc1,exports, core, common, Dropzone) { 
...
'use strict';
    ...
    Dropzone = Dropzone && Object.prototype.hasOwnProperty.call(Dropzone, 'default') ? Dropzone['default'] : Dropzone;
    ...
    var DropzoneConfig = /** @class */ (function () {
    ...
    var DropzoneDirective = /** @class */ (function () {
        function DropzoneDirective(zone, renderer, elementRef, differs, platformId, defaults) {
            ...
            this.disabled = false;
            this.DZ_INIT = new core.EventEmitter();
            this.DZ_ERROR = new core.EventEmitter();
            this.DZ_SUCCESS = new core.EventEmitter();
            this.DZ_SENDING = new core.EventEmitter();
            this.DZ_CANCELED = new core.EventEmitter();
            this.DZ_COMPLETE = new core.EventEmitter();
            this.DZ_PROCESSING = new core.EventEmitter();
            this.DZ_DROP = new core.EventEmitter();
            this.DZ_DRAGSTART = new core.EventEmitter();
            this.DZ_DRAGEND = new core.EventEmitter();
            this.DZ_DRAGENTER = new core.EventEmitter();
            this.DZ_DRAGOVER = new core.EventEmitter();
            this.DZ_DRAGLEAVE = new core.EventEmitter();
            this.DZ_THUMBNAIL = new core.EventEmitter();
            this.DZ_ADDEDFILE = new core.EventEmitter();
            this.DZ_ADDEDFILES = new core.EventEmitter();
            this.DZ_REMOVEDFILE = new core.EventEmitter();
            this.DZ_UPLOADPROGRESS = new core.EventEmitter();
            this.DZ_MAXFILESREACHED = new core.EventEmitter();
            ...
            this.DZ_SENDINGMULTIPLE = new core.EventEmitter();
            this.DZ_CANCELEDMULTIPLE = new core.EventEmitter();
            this.DZ_COMPLETEMULTIPLE = new core.EventEmitter();
            this.DZ_PROCESSINGMULTIPLE = new core.EventEmitter();
            this.DZ_RESET = new core.EventEmitter();
            this.DZ_QUEUECOMPLETE = new core.EventEmitter();
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DropzoneDirective, [{
    ...
    DropzoneDirective.propDecorators = {
        ...
        config: [{ type: core.Input, args: ['dropzone',] }],
        DZ_INIT: [{ type: core.Output, args: ['init',] }],
        DZ_ERROR: [{ type: core.Output, args: ['error',] }],
        DZ_SUCCESS: [{ type: core.Output, args: ['success',] }],
        DZ_SENDING: [{ type: core.Output, args: ['sending',] }],
        DZ_CANCELED: [{ type: core.Output, args: ['canceled',] }],
        DZ_COMPLETE: [{ type: core.Output, args: ['complete',] }],
        DZ_PROCESSING: [{ type: core.Output, args: ['processing',] }],
        DZ_DROP: [{ type: core.Output, args: ['drop',] }],
        DZ_DRAGSTART: [{ type: core.Output, args: ['dragStart',] }],
        DZ_DRAGEND: [{ type: core.Output, args: ['dragEnd',] }],
        DZ_DRAGENTER: [{ type: core.Output, args: ['dragEnter',] }],
        DZ_DRAGOVER: [{ type: core.Output, args: ['dragOver',] }],
        DZ_DRAGLEAVE: [{ type: core.Output, args: ['dragLeave',] }],
        DZ_THUMBNAIL: [{ type: core.Output, args: ['thumbnail',] }],
        ...
        DZ_UPLOADPROGRESS: [{ type: core.Output, args: ['uploadProgress',] }],
        DZ_MAXFILESREACHED: [{ type: core.Output, args: ['maxFilesReached',] }],
        ...
        DZ_SENDINGMULTIPLE: [{ type: core.Output, args: ['sendingMultiple',] }],
        DZ_CANCELEDMULTIPLE: [{ type: core.Output, args: ['canceledMultiple',] }],
        DZ_COMPLETEMULTIPLE: [{ type: core.Output, args: ['completeMultiple',] }],
        DZ_PROCESSINGMULTIPLE: [{ type: core.Output, args: ['processingMultiple',] }],
        DZ_RESET: [{ type: core.Output, args: ['reset',] }],
        DZ_QUEUECOMPLETE: [{ type: core.Output, args: ['queueComplete',] }],
        DZ_TOTALUPLOADPROGRESS: [{ type: core.Output, args: ['totalUploadProgress',] }]
    };
...
DropzoneComponent.ɵfac = function DropzoneComponent_Factory(t) { return new (t || DropzoneComponent)(ɵngcc0.ɵɵdirectiveInject(core.PLATFORM_ID)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DropzoneComponent, [{
    ...
    DropzoneComponent.propDecorators = {
        ...
        useDropzoneClass: [{ type: core.Input }],
        DZ_INIT: [{ type: core.Output, args: ['init',] }],
        DZ_ERROR: [{ type: core.Output, args: ['error',] }],
        DZ_SUCCESS: [{ type: core.Output, args: ['success',] }],
        DZ_SENDING: [{ type: core.Output, args: ['sending',] }],
        ...
        DZ_QUEUECOMPLETE: [{ type: core.Output, args: ['queueComplete',] }],
        DZ_TOTALUPLOADPROGRESS: [{ type: core.Output, args: ['totalUploadProgress',] }],
        directiveRef: [{ type: core.ViewChild, args: [DropzoneDirective, { static: true },] }]
    };
...
DropzoneModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DropzoneModule_Factory(t) { return new (t || DropzoneModule)(); }, imports: [[common.CommonModule], ɵngcc1.CommonModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DropzoneModule, { declarations: [DropzoneComponent, DropzoneDirective], imports: [ɵngcc1.CommonModule], exports: [ɵngcc1.CommonModule, DropzoneComponent, DropzoneDirective] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DropzoneModule, [{
    ...
    exports.DROPZONE_CONFIG = DROPZONE_CONFIG;
