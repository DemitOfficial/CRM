(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('resize-observer-polyfill'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-echarts', ['@angular/core','exports', '@angular/core', 'resize-observer-polyfill', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global['ngx-echarts'] = {}, global.ng.core, global.ResizeObserver, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,exports, core, ResizeObserver, rxjs, operators) { 'use strict';
