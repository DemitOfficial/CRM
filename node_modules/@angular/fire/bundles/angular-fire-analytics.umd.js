(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/fire'),require('@angular/fire/auth'),require('@angular/router'),require('@angular/platform-browser'),exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('rxjs/operators'), require('@angular/fire'), require('firebase/app'), require('@angular/router'), require('@angular/platform-browser'), require('@angular/fire/auth')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/analytics', ['@angular/core','@angular/fire','@angular/fire/auth','@angular/router','@angular/platform-browser','exports', '@angular/core', 'rxjs', '@angular/common', 'rxjs/operators', '@angular/fire', 'firebase/app', '@angular/router', '@angular/platform-browser', '@angular/fire/auth'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.fire,global.ng.fire.auth,global.ng.router,global.ng.platformBrowser,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.analytics = {}), global.ng.core, global.rxjs, global.ng.common, global.rxjs.operators, global.angular.fire, global.firebase, global.ng.router, global.ng.platformBrowser, global.angular.fire.auth));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, i0, rxjs, common, operators, i1, firebase, router, platformBrowser, auth) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireAnalytics = /** @class */ (function () {
        ...
        platformId, zone) {
             ...
             * @return {?}
             */function () { return rxjs.of(undefined); })), operators.switchMap(( /**
             * @return {?}
             */function () { return firebase__default['default'].analytics.isSupported().then(( /**
             * @param {?} it
             * @return {?}
             */function (/**
             * @param {?} it
             ...
             * @param {?} supported
             * @return {?}
             */ supported) { return supported ? rxjs.of(undefined) : rxjs.EMPTY; })), operators.map(( /**
             * @return {?}
             */function () {
