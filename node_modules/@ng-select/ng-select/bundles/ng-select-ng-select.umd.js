...
}(this, (function (ɵngcc0,ɵngcc1,exports, i0, forms, operators, rxjs, common) { 
var _c0 = ["content"];
var _c1 = ["scroll"];
var _c2 = ["padding"];
...
NgDropdownPanelComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgDropdownPanelComponent, selectors: [["ng-dropdown-panel"]], viewQuery: function NgDropdownPanelComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(_c0, true, i0.ElementRef);
        ɵngcc0.ɵɵstaticViewQuery(_c1, true, i0.ElementRef);
        ɵngcc0.ɵɵstaticViewQuery(_c2, true, i0.ElementRef);
    } if (rf & 2) {
        var _t;
...
NgSelectComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgSelectComponent, selectors: [["ng-select"]], contentQueries: function NgSelectComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgOptionTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgOptgroupTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgLabelTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgMultiLabelTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgHeaderTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgFooterTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgNotFoundTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgTypeToSearchTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgLoadingTextTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgTagTemplateDirective, true, i0.TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgLoadingSpinnerTemplateDirective, true, i0.TemplateRef);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgSelectComponent, [{
        ...
        args: [{
            ...
            args: [NgOptionTemplateDirective, { read: i0.TemplateRef }]
        }], optgroupTemplate: [{
            type: i0.ContentChild,
            args: [NgOptgroupTemplateDirective, { read: i0.TemplateRef }]
        }], labelTemplate: [{
            type: i0.ContentChild,
            args: [NgLabelTemplateDirective, { read: i0.TemplateRef }]
        }], multiLabelTemplate: [{
            type: i0.ContentChild,
            args: [NgMultiLabelTemplateDirective, { read: i0.TemplateRef }]
        }], headerTemplate: [{
            type: i0.ContentChild,
            args: [NgHeaderTemplateDirective, { read: i0.TemplateRef }]
        }], footerTemplate: [{
            type: i0.ContentChild,
            args: [NgFooterTemplateDirective, { read: i0.TemplateRef }]
        }], notFoundTemplate: [{
            type: i0.ContentChild,
            args: [NgNotFoundTemplateDirective, { read: i0.TemplateRef }]
        }], typeToSearchTemplate: [{
            type: i0.ContentChild,
            args: [NgTypeToSearchTemplateDirective, { read: i0.TemplateRef }]
        }], loadingTextTemplate: [{
            type: i0.ContentChild,
            args: [NgLoadingTextTemplateDirective, { read: i0.TemplateRef }]
        }], tagTemplate: [{
            type: i0.ContentChild,
            args: [NgTagTemplateDirective, { read: i0.TemplateRef }]
        }], loadingSpinnerTemplate: [{
            type: i0.ContentChild,
            args: [NgLoadingSpinnerTemplateDirective, { read: i0.TemplateRef }]
        }], dropdownPanel: [{
            type: i0.ViewChild,
            args: [i0.forwardRef(( /**
                                         * @return {?}
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgSelectModule, { declarations: [NgDropdownPanelComponent, NgOptionComponent, NgSelectComponent, NgOptgroupTemplateDirective, NgOptionTemplateDirective, NgLabelTemplateDirective, NgMultiLabelTemplateDirective, NgHeaderTemplateDirective, NgFooterTemplateDirective, NgNotFoundTemplateDirective, NgTypeToSearchTemplateDirective, NgLoadingTextTemplateDirective, NgTagTemplateDirective, NgLoadingSpinnerTemplateDirective, NgItemLabelDirective], imports: [ɵngcc1.CommonModule], exports: [NgSelectComponent, NgOptionComponent, NgOptgroupTemplateDirective, NgOptionTemplateDirective, NgLabelTemplateDirective, NgMultiLabelTemplateDirective, NgHeaderTemplateDirective, NgFooterTemplateDirective, NgNotFoundTemplateDirective, NgTypeToSearchTemplateDirective, NgLoadingTextTemplateDirective, NgTagTemplateDirective, NgLoadingSpinnerTemplateDirective] }); })();
