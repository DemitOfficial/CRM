...
'use strict';
    ...
    function calculateAutoPositioning(elBounds) {
        ...
        var height = elBounds.height, width = elBounds.width, top = elBounds.top, bottom = elBounds.bottom, left = elBounds.left, right = elBounds.right;
        ...
        var collisionAll = collisionTop && collisionBottom && collisionLeft && collisionRight;
        ...
        if (collisionAll) {
            ...
            return postions.reduce(function (prev, next) { return elBounds[prev] > elBounds[next] ? prev : next; });
        }
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ColorPickerDirective, [{
    ...
    ColorPickerDirective.propDecorators = {
        ...
        cpPresetColorsClass: [{ type: core.Input }],
