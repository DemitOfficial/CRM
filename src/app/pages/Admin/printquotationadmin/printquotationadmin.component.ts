...
@Component({
  selector: 'app-printquotationadmin',
  templateUrl: './printquotationadmin.component.html',
  styleUrls: ['./printquotationadmin.component.scss']
})
export class PrintquotationadminComponent implements OnInit {
