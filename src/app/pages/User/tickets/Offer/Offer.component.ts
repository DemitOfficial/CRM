...
buton:boolean=false;
  ...
  ngOnInit() {
    ...
    this.ticketservice.GetFunnel().subscribe((next:any)=>{
      ...
      debugger;
       this.getid=data.filter(x=>x.ticketName=="Offer or Inquires");
...
console.log(this.SelectedValues);
  ...
  {
    // this.spinner.show()
    this.ticketservice.GetUserOfferTickets().subscribe((next:any)=>{
      this.gettickets=next.res
      // this.spinner.hide()
...
this.getticketinfo();
this.toastr.success('Offer Ticket Created  Successfully!', 'Congrats', {
  titleClass: "center",
  messageClass: "center"
});
...
this.spinner.hide();
   ...
   deleteticket(Id:any)
   {
    ...
    this.ticketservice.removeticket(Id).subscribe((next:any)=>{
      this.getticketinfo();
      this.toastr.success('Ticket Deleted Successfully!', 'Congrats', {
        titleClass: "center",
        messageClass: "center"
      });
       },error=>{
